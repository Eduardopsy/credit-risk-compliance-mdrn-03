// File: src/modules/compliance/CreditRisk.Compliance.Infrastructure/Persistence/Repositories/OutboxRepository.cs
...
public sealed class OutboxRepository : IOutboxRepository
{
    ...
    public OutboxRepository(ComplianceDbContext dbContext)
    {
